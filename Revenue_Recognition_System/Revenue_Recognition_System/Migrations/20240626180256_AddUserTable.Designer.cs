...
namespace Revenue_Recognition_System.Migrations
{
    ...
    [Migration("20240626180256_AddUserTable")]
            ...
            modelBuilder.Entity("Revenue_Recognition_System.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdUser = 1,
                            Login = "admin",
                            Password = "WTDTVyCT802NykKe2rWsBz7rhQK30s+BqPXEaFWDSjc=",
                            RefreshToken = "NmmAJEtrxBqlIwR6QO6vMpiTdRarhN3ymghpsx8Ehjg=",
                            RefreshTokenExp = new DateTime(2024, 6, 28, 20, 2, 56, 153, DateTimeKind.Local).AddTicks(8603),
                            Role = 1,
                            Salt = "BOM69PB5Cugh+Ws2UxOoyA=="
                        });
                });
